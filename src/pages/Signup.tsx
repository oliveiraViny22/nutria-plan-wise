...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen gradient-hero flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 bg-secondary/30">
        <motion.div
        ...
        >
          <div className="w-64 h-64 mx-auto mb-8 rounded-full gradient-primary opacity-20" />
