...
const QUICK_START_TEMPLATES: QuickStartTemplate[] = [
  ...
  },
  {
    ...
    description: "Arroz + Feijão + Proteína + Vegetal",
    meal_type: "lunch",
    icon: Sun,
    roles: [
      { role_name: "carboidrato_base", is_required: true, min_quantity_grams: 100, max_quantity_grams: 200, categories: ["carboidratos"] },
      { role_name: "leguminosa", is_required: true, min_quantity_grams: 80, max_quantity_grams: 150, categories: ["leguminosas"] },
      { role_name: "proteina_principal", is_required: true, min_quantity_grams: 100, max_quantity_grams: 200, categories: ["proteinas"] },
      { role_name: "vegetal", is_required: true, min_quantity_grams: 50, max_quantity_grams: 150, categories: ["vegetais"] },
      { role_name: "gordura_boa", is_required: false, min_quantity_grams: 5, max_quantity_grams: 15, categories: ["gorduras"] },
    ],
  },
  {
    id: "dinner-light",
    name: "Jantar Leve",
    description: "Proteína + Carboidrato + Vegetais",
    meal_type: "dinner",
    icon: Moon,
    roles: [
      { role_name: "proteina_principal", is_required: true, min_quantity_grams: 100, max_quantity_grams: 180, categories: ["proteinas"] },
      { role_name: "carboidrato_base", is_required: true, min_quantity_grams: 80, max_quantity_grams: 150, categories: ["carboidratos"] },
